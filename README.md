...
### 11/09/2023
- The group came across an issue with the footer. Whilst the footer was functioning as it should on most pages. The addition of the search page on the site raised an issue with the footer. Seemingingly tbe footer would sometimes not move around the page correctly and cover up certain search results if their were enough in a certain search. In order to fix this several group members discussed what caused this issue. After consideration some minor changes were made to the HTML and CSS for the foote, this allowed for the positioning footer to adjust correctly depending on the number of search results.
